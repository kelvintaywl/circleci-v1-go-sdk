...
// WithProjectSlug adds the projectSlug to the list projects params
func (o *ListProjectsParams) WithProjectSlug(projectSlug string) *ListProjectsParams {
	o.SetProjectSlug(projectSlug)
	return o
}

// SetProjectSlug adds the projectSlug to the list projects params
func (o *ListProjectsParams) SetProjectSlug(projectSlug string) {
